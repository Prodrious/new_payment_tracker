...
export default function Home() {
  ...
  const handleClearData = async () => {
    if (confirm("This will permanently erase all remote MongoDB records. Continue?")) {
      setStudents([]);
      setSchedules([]);
          ...
          <div className="mt-auto pt-6 border-t border-slate-800 space-y-4">
            ...
            <div className="flex items-center gap-3 px-2 bg-slate-800/40 p-3 rounded-2xl border border-slate-700/50">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-slate-500 truncate uppercase font-bold">Node.js / Next.js</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-8 shrink-0 z-30">
            ...
            <div className="flex items-center gap-2">
              ...
              {isSyncing ? (
                ...
                <div className="flex items-center gap-1.5 bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
                  ...
                  <span className="text-[9px] font-black text-emerald-400 uppercase tracking-widest">Cloud Saved</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden sm:flex flex-col items-end mr-4">
              <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest">Server Status: Online</span>
              <span className="text-xs font-bold text-slate-400 uppercase tracking-tighter">Next.js Edge Runtime</span>
            </div>
